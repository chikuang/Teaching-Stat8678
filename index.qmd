...
|   ⏳   |         Two Sample $t$-test for Independent and Paired Datasets   |   13  |
|        |   **📜Exam  **    |         |
|   ⏳   |         Exam   | 14  |
|        |   **📘 Part 3: Regression Analysis **    |         |
|   ⏳   |         Analysis of Variance   | 14  |
|   ⏳   |         Intro to Regression Analysis     | 15  |
|     |        ⛱ Spring Break  🌊    |   |
|   ⏳   |         Regression with Interaction Effects   | 16  |
|   ⏳   |         Linear Mixed Effects Model I   | 17  |
|   ⏳   |         Linear Mixed Effects Model II   | 18  |
<!-- 🚧🛠️⏳   -->
