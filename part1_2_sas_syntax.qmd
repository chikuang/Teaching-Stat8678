...
![](figs/part1/syntax_1.png)

::: callout-example
How many statements are in the following step?

![](figs/part1/syntax_ex1.png)
:::
...
![](figs/part1/syntax_error1.png)

When SAS encounters a syntax error, SAS underlines the error and the following information is written to the SAS log: + the word **ERROR** or **WARNING** + the location of the error + an explanation of the error

::: callout-example
This program has three syntax errors. What are the errors?

![](figs/part1/syntax_ex2.png)
:::
