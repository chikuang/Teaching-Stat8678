...
::: {.callout-example title="Examples of leakage"}
...
::: {.callout-note title="Predictive Modelling Workflow"}
...
::: {.callout-example title="Continuous Outcome Prediction"}
...
:::{.callout-example title="Binary Outcome Prediction with Logistic Regression"}
...
::: {.callout-warning title="Important Shift"}
