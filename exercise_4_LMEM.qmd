# Exercise 4: Linear Mixed Effects Model {.unnumbered}
...
**Answer:**
It suggests that location-to-location variability is important and should be included in the model. The data are better explained when location is treated as a random effect.
